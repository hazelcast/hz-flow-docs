...
NOTE: MC is preconfigured as the identity provider for {short-product-name} with the configuration prefixed `flow.security` in the Docker Compose files below. Changing these may lead to unexpected results.

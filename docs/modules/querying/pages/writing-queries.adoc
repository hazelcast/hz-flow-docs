...
* link:/docs/data-formats/csv.adoc[CSV]
* link:/docs/data-formats/xml.adoc[XML]
* link:/docs/data-formats/protobuf.adoc[Protobuf]
* link:/docs/data-formats/avro.adoc[Avro]

If you need a custom format that's not listed here, read about {short-product-name}'s support for link:/docs/data-formats/custom-data-formats.adoc[custom model formats].

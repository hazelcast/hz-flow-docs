...
An {short-product-name} Workspace is a collection of schemas, API specs and Taxi projects that describe
...
<ImageWithCaption src=\{PublishingFromSources} addLightBackground=\{true}/>

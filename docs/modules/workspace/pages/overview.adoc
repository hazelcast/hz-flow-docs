...
For more information, see the topics on using xref:describing-data-sources:open-api.adoc[OpenAPI] or xref:data-formats:protobuf.adoc[Protobuf] to describe your data sources.
...
Continue learning about {short-product-name} by xref:describing-data-sources:configuring-connections.adoc[connecting your data sources].
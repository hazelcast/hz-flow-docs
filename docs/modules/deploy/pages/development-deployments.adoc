...
* Understand how to configure {short-product-name} via xref:deploy:configure.adoc#docker[application properties] or xref:deploy:configure.adoc#setting-as-environment-variables[environment variables]

...
// Author's note - need to link to missing topic i.e. [Taxi schema](#editing-a-taxi-schema) 

NOTE: Before continuing, make sure you've enabled schema editing through the UI. If you're running through one of our tutorials, don't worry, we've already configured this for you.

// Author's note - need to link to missing topic i.e. [enabled schema editing through the UI](./enable-ui-schema-editing/). 

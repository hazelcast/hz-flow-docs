...
// placeholder for graphic - RegisteredInProjectView
...
// placeholder for graphic - <ImageWithCaption src={FirstServiceRegistration} caption={'The service has been published to {short-product-name}'}></ImageWithCaption> 
...
// placeholder for graphic - <ImageWithCaption src={FirstServiceDiagram} caption={'The service is shown in {short-product-name}\'s service diagrams'}></ImageWithCaption> 

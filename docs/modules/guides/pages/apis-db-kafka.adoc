...
cd flow-films-demo
curl https://github.com/flowapi/demos/raw/main/importing-through-ui/docker-compose.yml -odocker-compose.yml
curl https://github.com/flowapi/demos/raw/main/importing-through-ui/docker/schema-server/schema-server.conf -oflow/schema-server
curl https://github.com/flowapi/demos/raw/main/importing-through-ui/docker/schema-server/projects/taxi.conf -oflow/schema-server/projects
curl https://github.com/flowapi/demos/raw/main/importing-through-ui/services.conf -oflow/config
docker compose up -d
----
...
Author's Note - last link in the above does not work
...
To get started, click *Add a data source* on the home page of {short-product-name}, or navigate to http://localhost:9021/data-source-manager/add
Author's note - broken link

=== Define the database connection

First, we need to tell {short-product-name} how to connect to the database.

* Navigate to http://localhost:9021/data-source-manager/add
...
----
cd flow/schema-server/projects
----
...
image:new-release-film-announcement.png[]

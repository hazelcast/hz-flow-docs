...
wget https://github.com/flowapi/demos/raw/main/importing-through-ui/docker/schema-server/schema-server.conf -P flow/schema-server
wget https://github.com/flowapi/demos/raw/main/importing-through-ui/docker/schema-server/projects/taxi.conf -P flow/schema-server/projects
wget https://github.com/flowapi/demos/raw/main/importing-through-ui/services.conf -P flow/config
docker compose up -d
----

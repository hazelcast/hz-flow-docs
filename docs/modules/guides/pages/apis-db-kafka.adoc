...
* https://docs.taxilang.org/language-reference/taxi-language/[Understand Taxi]
...
* https://docs.taxilang.org/language-reference/describing-services/[Describe REST APIs in Taxi]
...
| Namespace
| `com.hazelflix.films.mykafka` (should already be populated)

...
Follow the xref:deploying:development-deployments.adoc[Development Quickstart] to get your {short-product-name} server running and ready to build your models.

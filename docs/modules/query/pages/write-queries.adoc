...
Queries are written in https://docs.taxilang.org/language-reference/query-with-taxiql/[TaxiQL], an open source
query language for data.

TIP: https://docs.taxilang.org/language-reference/query-with-taxiql/[TaxiQL] is a powerful query language, and  the Taxi documentation has details on the syntax, which we haven't duplicated here.

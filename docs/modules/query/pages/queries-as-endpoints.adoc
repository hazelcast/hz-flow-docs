...
You might decide that instead of xref:query:writing-queries.adoc#submitting-queries[submitting queries] directly to {short-product-name}, or using one of our

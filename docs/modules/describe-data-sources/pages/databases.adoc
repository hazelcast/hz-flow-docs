 ...
 ** If you haven't yet created your connection, you can click *Add new connection*. For details, see xref:connect-data-sources:connect-a-database.adoc#create-a-connection-when-importing-a-new-data-source[adding a database connection]

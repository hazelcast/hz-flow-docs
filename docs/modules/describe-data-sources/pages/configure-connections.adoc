...
TIP: See also xref:deploy:manage-secrets.adoc[Managing Secrets] to see how to securely manage sensitive information in your connections.
...
Continue learning about {short-product-name} by xref:query:writing-queries.adoc[query your data].